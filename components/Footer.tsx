    ...
    <footer className="border-t border-white/5 bg-primary py-12 md:py-16 relative z-10">
      <div className="max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12 text-start">
        ...
        <div>
          ...
          <ul className="space-y-2 text-neutral-dim text-sm">
            <li><a href="https://www.linkedin.com/company/al-nebras-engineering-office/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">LinkedIn</a></li>
            <li><a href="https://www.facebook.com/profile.php?id=61585293540955" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Facebook</a></li>
